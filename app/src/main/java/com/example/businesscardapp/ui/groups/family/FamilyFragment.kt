package com.example.businesscardapp.ui.groups.family
...
import com.example.businesscardapp.databinding.FragmentFamilyBinding
...
class FamilyFragment : Fragment() {
    ...
    private fun registerEvents(){
        binding.familyGroupListView.adapter = customBusinessCardAdapter
        binding.familyGroupListView.setOnItemClickListener { parent, view, position, id ->
