package com.example.businesscardapp.ui.groups.school
...
import com.example.businesscardapp.databinding.FragmentSchoolBinding
...
class SchoolFragment : Fragment() {
    ...
    private fun registerEvents(){
        binding.schoolGroupListView.adapter = customBusinessCardAdapter
        binding.schoolGroupListView.setOnItemClickListener { parent, view, position, id ->
