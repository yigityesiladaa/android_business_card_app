package com.example.businesscardapp.ui.groups.social
...
import com.example.businesscardapp.databinding.FragmentSocialBinding
...
class SocialFragment : Fragment() {
    ...
    private fun registerEvents(){
        binding.socialGroupListView.adapter = customBusinessCardAdapter
        binding.socialGroupListView.setOnItemClickListener { parent, view, position, id ->
